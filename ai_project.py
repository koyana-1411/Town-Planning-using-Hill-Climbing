...
Original file is located at
    https://colab.research.google.com/drive/1yTGB6bsB51M2LuvTjq1aTrdJq7UjBv_U
"""
...
class Space():
    ...
    def output_image(self, filename):
        ...
        house = Image.open("/content/MicrosoftTeams-image (3).png").resize(
            (cell_size, cell_size)
        )
        hospital = Image.open("/content/MicrosoftTeams-image (2).png").resize(
            (cell_size, cell_size)
        )
...
for i in range(15):
    s.add_house(random.randrange(s.height), random.randrange(s.width))
# Use local search to determine hospital placement
hospitals = s.random_restart(25,image_prefix="hospitals", log=TRUE)
